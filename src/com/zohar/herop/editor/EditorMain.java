...
public class EditorMain extends JPanel {

	public EditorMain() {
//		ImageIcon icon = new ImageIcon("java-swing-tutorial.JPG");
		JTabbedPane jtbExample = new JTabbedPane();
		JPanel jplInnerPanel1 = new BiontPanel();
		jtbExample.addTab("Biont", null, jplInnerPanel1, "Biont");
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new EditorMain(),
				BorderLayout.CENTER);
